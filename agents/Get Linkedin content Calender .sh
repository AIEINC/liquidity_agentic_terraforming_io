#!/bin/bash
# Auto-generated launcher for Get Linkedin content Calender 
echo "Running agent: Get Linkedin content Calender "
cat <<EOF
{
  "name": "Get Linkedin content Calender ",
  "flow": [
    {
      "id": 1,
    ...
    },
    {
      ...
      "mapper": {
        "limit": "10",
        "select": "item",
        "database": "1201124570fe800694fce185db0ce624"
      },
      "metadata": {
        "designer": {
          "x": 300,
          ...
          },
          {
            ...
            "options": {
              "store": [
                ...
                {
                  "label": "Type (Multi select)",
                  "value": "Type |&*^%$#@| multi_select"
                },
                {
                  "label": "Post (Rich text)",
    ...
    },
    {
      ...
      "mapper": {
        "properties_value": "{{7.properties_value}}"
      },
      "metadata": {
        "designer": {
          "x": 600,
